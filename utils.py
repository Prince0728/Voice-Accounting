...
def predict_result(new_text, model_path='C:/Users/user/Desktop/voice_accounting/model/bert_model.pth'):
    # 載入模型
...
llm = Llama(model_path="C:/Users/user/Desktop/voice_accounting/model/ckip-llama27bchat-q8.gguf.gguf", n_gpu_layers=12)
